                    ...
                    {children.map((child, index) => {
                        ...
                        return (
                            <fieldset key={index} className="mitten-child-card">
                                ...
                                {colors.length > 0 && (
                                    <fieldset className="mitten-subfieldset" {...inspectorProps({ fieldId: 'colorOptions' })}>
                                        <legend className="mitten-sublegend">
                                            Favorite colors <span className="mitten-legend-hint">&mdash; select all that apply</span>
                                        </legend>
                                        {/* Colour names are single short words, so they pack more
                                            densely than the interest labels. */}
                                        <div className="mitten-checkbox-grid mitten-color-grid">
                                            {colors.map(option => (
                                                <label key={option} className="mitten-choice">
